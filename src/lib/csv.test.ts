...
import { CSV_HEADERS, csvFileName, promptsToCsv, toCsv } from '@/lib/csv';
import type { Folder, Project, Prompt } from '@/lib/definitions';
import { buildTree } from '@/lib/tree';

const tree = buildTree(
  [{ id: 'trabajo', name: 'Trabajo', createdAt: '', ownerId: 'u' }] as Project[],
  [
    { id: 'nomina', name: 'Nómina', projectId: 'trabajo', parentId: null, createdAt: '', ownerId: 'u' },
    { id: 'recibos', name: 'Recibos', projectId: 'trabajo', parentId: 'nomina', createdAt: '', ownerId: 'u' },
  ] as Folder[]
);
