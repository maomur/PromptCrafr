...
>(({ className, children, position = "popper", ...props }, ref) => (
  /* 
     ELIMINAMOS EL PORTAL: Al renderizar sin Portal dentro de un Diálogo, el selector 
     hereda el contexto de foco y permite que las flechas del teclado funcionen nativamente.
     Añadimos z-[100] para asegurar visibilidad.
  */
  <SelectPrimitive.Content
    ...
    position={position}
    onKeyDown={(e) => {
      // SOPORTE TAB: Si el usuario pulsa Tab, seleccionamos automáticamente el ítem resaltado
      if (e.key === 'Tab') {
