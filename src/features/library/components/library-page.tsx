...
import ProjectSidebar from '@/features/folders/components/folder-tree-sidebar';
...
import { useLibrary, type ItemKind } from '@/features/library/hooks/use-library';
import { useToast } from '@/hooks/use-toast';
import { type FolderInput, type LibraryFilter, type Location, filterKey, matchesFilter } from '@/features/folders/types';
import { type Link, type Prompt, type PromptCategory } from '@/features/library/types';
 ...
 *
 * Coordina la interfaz; los datos y las operaciones vienen enteros de
 * `useLibrary`, así que aquí no hay ninguna regla de negocio.
 */
