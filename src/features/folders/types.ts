 ...
 *
 * Un proyecto es una carpeta principal y una carpeta es una subdivisión suya.
 * Ambos viven en almacenes distintos de la base local, pero de puertas afuera
 * son el mismo concepto: `tree.ts` los une en un solo árbol.
 */
